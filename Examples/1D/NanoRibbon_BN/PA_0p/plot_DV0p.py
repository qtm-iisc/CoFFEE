...
ax.axvline(x = V_0[0,0]*0.52918,color = 'darkorange',linestyle = '--',lw = 3.2,label = "Vacancy pos.")
ax.legend(loc = 0,fontsize = 18)
ax.set_xlim(V_0[0,0]*0.52918-0.1,V_0[-1,0]*0.52918)
...
print("Value far from defect: %2.4f"%( V_diff[len(V_0)/2]))
plt.show()
